...
Singleton {
    ...
    function batteryIcon() {
        ...
        if (pct > 95) return batteryService.charging ? "󰂋" : "󰁹"
        if (pct > 55) return batteryService.charging ? "󰢞" : "󰂀"
        if (pct > 45) return batteryService.charging ? "󰂈" : "󰁽"
        if (pct > 20) return batteryService.charging ? "󰂆" : "󰁻"
